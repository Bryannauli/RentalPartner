...
<section class="bg-white p-6 rounded shadow max-w-4xl mx-auto !mt-30 !mb-10">
  ...
  <div>
    ...
    <input id="start_date" type="date" class="border p-2 rounded w-full" />
  </div>
  <div>
    <label for="end_date" class="block mb-1 font-medium text-gray-700">Tanggal Selesai</label>
    <input id="end_date" type="date" class="border p-2 rounded w-full" />
  </div>
  ...
  <button class="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition !ml-85">Pesan Sekarang</button>
</section>
@endsection
