...
<a href="{{ url('/upgrade') }}" 
   ...
   class="inline-flex items-center transition-colors duration-200 hover:!underline hover:text-blue-800">
  Try Now
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
      <div>
        <div class="flex flex-col items-center !mt-40 !mb-20">
          ...
          <div class="rounded-full !mb-10 bg-blue-600 w-16 h-16 flex items-center justify-center mx-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-car-front-fill" viewBox="0 0 16 16">
      ...
      <div>
        ...
        <div class="flex flex-col items-center !mt-40">
          <div class="rounded-full bg-blue-600 !mb-10 w-16 h-16 flex items-center justify-center mx-auto">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 8V5a1 1 0 00-1-1H6a1 1 0 00-1 1v3m9 8h-4m4-8v3m-6 1a1 1 0 11-2 0 1 1 0 012 0z"></path>
            </svg>
          </div>
      ...
      <div>
        <div class="flex flex-col items-center !mt-40">
          <div class="rounded-full bg-blue-600 !mb-10 w-16 h-16 flex items-center justify-center mx-auto">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h0m-6 0h0m6 0v4m-3-4v4"></path>
            </svg>
          </div>
      ...
      <div>
        <div class="flex flex-col items-center !mt-40">
          <div class="rounded-full bg-blue-600 !mb-10 w-16 h-16 flex items-center justify-center mx-auto">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 5v2a2 2 0 002 2h2a2 2 0 002-2V5m-3 5h3m-3 4h3m-3 4h3M5 10V5a2 2 0 00-2-2H2a2 2 0 00-2 2v5m3 0h3m-3 4h3m-3 4h3M5 19v-2a2 2 0 00-2-2H2a2 2 0 00-2 2v2m3 0h3m-3-4h3m3 4h3M5 10v-2a2 2 0 00-2-2H2a2 2 0 00-2 2v2m3 0h3m-3 4h3"></path>
            </svg>
          </div>
