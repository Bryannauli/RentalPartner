<section class="py-16 bg-white">
  ...
  <div class="container mx-auto flex flex-col md:flex-row items-center">
    ...
    <!-- Left Text -->
    <div class="md:w-1/2 px-6 !mt-10">
        
    <div class="flex items-center mb-2">
    <h2 class="!text-3xl font-bold text-blue-600 ">Rental Partner</h2>
  </div>
  <div class="flex items-center mb-15">
    <div class="w-10 h-5 flex items-center justify-center rounded-full ml-4 border border-gray-300">
      <span class="text-gray-700 text-xl"></span>
    </div>
    <div class="animate-fade-in-up">
    <h3 class="text-gray-700 !text-2xl md:text-xl font-semibold !ml-3">
  <strong>Available as a car rental  with the best service.</strong>
</h3>
    </div>
  </div>
...
<!-- Right Images -->
<div class="md:w-1/2 px-6 mt-0 md:mt-0 relative !mb-18">
  <img 
    src="{{ asset('images/mobil.png') }}"
    class=" w-85 h-50 absolute left-70 opacity-100 translate-y-5 transition-all duration-1000 ease-out hover:opacity-100 hover:translate-y-0"
    alt="Danau Toba view">
</div>
