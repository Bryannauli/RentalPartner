...
<section class="bg-gray-100 py-16" id="featured-cars">
    <div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-8">
    <h2 class="text-xl font-bold">Featured Cars</h2>
        </div>
...
<div class="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col">
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
          ...
          <div class="mt-5">
            <a href="#" class="book block bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 !text-white  font-bold text-center py-5 rounded-xl transition duration-300">
              BOOKING NOW
            </a>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col">
        <img src="/images/hondacrv.png" alt="Alphard" class="w-full h-[500px] md:h-[500px] object-cover !mt-10">
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
      ...
      <div class="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col">
        ...
        <div class="card3 p-6 flex flex-col flex-grow">
