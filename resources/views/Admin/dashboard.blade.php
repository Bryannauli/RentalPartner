    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{-- route('admin.users.index') --}}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="p-3">
                                <a href="{{-- route('admin.users.show', $user->id) --}}" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-1 px-3 rounded">Lihat</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{-- route('admin.owners.index') --}}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{-- route('admin.posts.index') --}}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{-- route('admin.reviews.index') --}}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            --}} {{ $review->rating }}/5</td>
                            <td class="p-3">
                                <a href="{{-- route('admin.reviews.show', $review->id) --}}" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-1 px-3 rounded">Lihat</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md col-span-1 lg:col-span-2">
             <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{-- route('admin.bookings.index') --}}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="p-3">
                                <a href="{{-- route('admin.bookings.show', $booking->id) --}}" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-1 px-3 rounded">Lihat</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
